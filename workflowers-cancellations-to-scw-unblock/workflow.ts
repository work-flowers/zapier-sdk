// Source of truth: https://github.com/work-flowers/zapier-sdk/tree/main/workflowers-cancellations-to-scw-unblock
//
// Deletion propagation for the two-way calendar-blocking pair. The
// `event_updated` trigger workflowers-events-to-scw-busy runs on delivers
...
// cancelled work.flowers event up in the GCal Sync Map, delete its SCW Busy block,
...
// --- Bindings ----------------------------------------------------------------
// The work.flowers Google credential lives on the TRIGGER (the calendar whose
// cancellations are being read); the SCW credential is bound here
