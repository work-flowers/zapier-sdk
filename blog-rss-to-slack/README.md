...
- **Workflow ID:** `019fffd7-a3e5-733a-b85b-57bea38537c0` · account-visible · enabled
...
Done 2026-08-14: published disabled (running both Zaps would have double-posted every
new entry), then the classic Zap "Share new Blog Posts in Slack" was turned off and
this durable enabled the same day (classic-off confirmed by Dennis, not
machine-verifiable). Polling has no backfill, so anything published inside that brief
gap goes unannounced.
