// Source of truth: https://github.com/work-flowers/zapier-sdk/tree/main/gcal-block-sweep-peter
//
...
// (scw-events-to-workflowers-block-peter / workflowers-events-to-scw-busy-peter). Those
...
const WF_CALENDAR = "peter@work.flowers";
const SCW_CONNECTION = "gcal_scw";
const SCW_CALENDAR = "pgao@securecodewarrior.com";
...
function mirrorSpec(dir: Direction, eventId: string, event: FoundEvent) {
  ...
  const description =
    dir.mode === "busy"
      ? null
      : `${SYNC_MARKER} source:${eventId}\nMirrored from ${dir.sourceCalendar} by gcal-block-sweep-peter. Edits here will be overwritten.`;
